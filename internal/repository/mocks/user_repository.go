...
func (_m *UserRepository) Create(ctx context.Context, info *model.CreateUserRequest) (int64, error) {
...
func (_m *UserRepository) Get(ctx context.Context, chatId int64) (*model.GetUserResponse, error) {
...
func (_m *UserRepository) Update(ctx context.Context, info *model.UpdatUsereRequest) error {
	ret := _m.Called(ctx, info)
